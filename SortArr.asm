...
num:								; displaying number of inputs message
...
sort:								; getting sotring type
		mov edx,OFFSET Sort_type_msg
		call WriteString
		call Crlf
		call ReadInt
...
rev:								; getting ascending or descending sorting type
		mov edx,OFFSET Reverse_ornot_msg
		call WriteString
		call Crlf
		call ReadInt
		mov Var,Eax
